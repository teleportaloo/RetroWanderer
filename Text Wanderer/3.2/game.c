...
char *initscreen(int *num, long *score, int *bell, int maxmoves, char *keys, game *game)
{
    ...
    if(game->maxmoves < 1) game->maxmoves = -1;
    ...
    /* Edit screen memory functions */
        ...
        switch(screen[game->ny][game->nx])
        {
            ...
            case ' ':
            {
                ...
                screen[game->ny][game->nx] = '@';
                {
                    ad_move_ch('@', game->y+1,game->x+1, game->ny+1,game->nx+1, ' ',0,under, Hint_Slow);
                ...
                break;
            case 'O':
                if((game->nx == 0 )||(game->nx == (ROWLEN-1))) break;
                ...
                if(screen[game->y][game->nx*2-game->x] == ' ')
                {
                    ...
                    ad_move_ch('O', game->ny+1,game->nx+1, game->y+1,game->nx*2-game->x+1, ' ',0,0, Hint_Slow);
                    ad_move_ch('@', game->y+1, game->x+1,  game->ny+1,game->nx+1, ' ',0, 0, Hint_Slow);
            ...
            case '^':
                ...
                if(screen[game->y][game->nx*2-game->x] == ' ')
                {
                    ...
                    ad_move_ch('^', game->ny+1,game->nx+1, game->y+1,game->nx*2-game->x+1, ' ',0, 0, Hint_Slow);
                    ad_move_ch('@', game->y+1, game->x+1,  game->ny+1,game->nx+1, ' ',0, 0, Hint_Slow);
            ...
            case '<':
            case '>':
                if((game->ny == 0) || ( game->ny == (NOOFROWS-1))) break;
                ...
                if(screen[game->ny*2-game->y][game->x] == ' ')
                {
                    ...
                    ad_move_ch(screen[game->ny*2-game->y][game->x], game->ny+1,game->nx+1, game->ny*2-game->y+1,game->x+1, ' ',0, 0, Hint_Slow);
                    ad_move_ch('@', game->y+1, game->x+1,  game->ny+1,game->nx+1, ' ',0, 0, Hint_Slow);
                ...
                break;
            case '~':
                if(((2*game->nx-game->x) < 0) ||((game->ny*2-game->y) > NOOFROWS)||((game->ny*2-game->y) < 0)||((2*game->nx-game->x) > ROWLEN)) break;
                ...
                if(screen[game->ny*2-game->y][game->nx*2-game->x] == ' ')
                {
                    ...
                    screen[game->ny][game->nx] = '@';
                    {
                        ad_move_ch('~', game->ny+1,game->nx+1, game->ny*2-game->y+1,game->nx*2-game->x+1, ' ',0, 0, Hint_Slow);
                        ad_move_ch('@', game->y+1, game->x+1,  game->ny+1,game->nx+1, ' ',0,0, Hint_Slow);
            ...
            case 'X':
                if(game->nf == game->diamonds)
                {
                    *score+=250;
                    ...
                    ad_move_ch('@', game->y+1, game->x+1,  game->ny+1,game->nx+1, ' ',0,'X', Hint_Slow);
                    ad_refresh();
                    return NULL;
                }
                break;
